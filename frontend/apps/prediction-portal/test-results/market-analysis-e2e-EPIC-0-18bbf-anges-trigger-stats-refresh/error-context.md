...
- Name: market-analysis-e2e.spec.ts >> EPIC-04 Market Analysis — End-to-End (real services) >> E2E-02: Filter changes trigger stats refresh
- Location: e2e\market-analysis-e2e.spec.ts:24:7
...
Call log:
  - waiting for locator('[data-testid="kpi-card"]').first() to be visible
