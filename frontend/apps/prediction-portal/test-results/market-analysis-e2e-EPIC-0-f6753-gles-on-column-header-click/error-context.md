...
- Name: market-analysis-e2e.spec.ts >> EPIC-04 Market Analysis — End-to-End (real services) >> E2E-03: DataTable sort toggles on column header click
- Location: e2e\market-analysis-e2e.spec.ts:46:7
...
Call log:
  - waiting for locator('[data-testid="market-data-table"]') to be visible
